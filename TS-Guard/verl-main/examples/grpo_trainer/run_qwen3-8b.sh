...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=[$data_dir/data/agentsafety/binary_prompt_train_agentalign-harm-strict.parquet] \
    data.val_files=[$data_dir/data/agentsafety/binary_prompt_val_agentalign-harm-strict.parquet,$data_dir/data/agentsafety/binary_prompt_val_agentalign-benign-sampling-1-5.parquet] \
    ...
    trainer.project_name='verl_grpo_ashell_guardian_v2.1.0-strict' \
