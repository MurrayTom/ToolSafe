...
- [**TS-Flow**]([./ToolSafe](https://github.com/MurrayTom/ToolSafe)) – **Feedback-driven reasoning framework** that reduces harmful tool executions while improving benign task performance under prompt injection attacks.
